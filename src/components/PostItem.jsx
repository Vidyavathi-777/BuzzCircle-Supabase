...
const PostItem = ({ post }) => {
  ...
  //     const { data, error } = await supabase.from('users').select('avatar_url,name').eq('id', post.user_id).single()
  //     // console.log(data)
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="relative group">
                      ...
                      <div className="relative w-12 h-12 rounded-full bg-gradient-to-tr from-[#8A2BE2] to-[#491F70] shadow-lg flex items-center justify-center text-white font-semibold text-lg">
